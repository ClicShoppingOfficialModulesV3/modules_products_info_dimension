 ...
 */
  ...
  class pi_products_info_dimension {
    public $code;
    public $group;
    public $title;
    public $description;
    ...
    public function execute() {
      ...
      if ($CLICSHOPPING_ProductsCommon->getID() && isset($_GET['Products']) ) {
        ...
        if ( $products_dimension != '') {
          ...
          $CLICSHOPPING_Template->addBlock($products_dimension_content, $this->group);
        }
      }
    } // public function execute
    ...
    public function install() {
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_INFO_DIMENSION_STATUS',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_INFO_DIMENSION_CONTENT_WIDTH',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_INFO_DIMENSION_POSITION',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_INFO_DIMENSION_SORT_ORDER',
          'configuration_value' => '104',
    ...
    public function keys() {
      return array (
        'MODULE_PRODUCTS_INFO_DIMENSION_STATUS',
        'MODULE_PRODUCTS_INFO_DIMENSION_CONTENT_WIDTH',
        'MODULE_PRODUCTS_INFO_DIMENSION_POSITION',
        'MODULE_PRODUCTS_INFO_DIMENSION_SORT_ORDER'
      );
    }
  }
